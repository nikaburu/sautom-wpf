...
{
    public sealed class ClientAddNewOrderViewModel : NavigationAwareNotificationObject
    {
	    #region Constructor

	    public ClientAddNewOrderViewModel([Dependency("Sautom.Client.Modules.Client.Mapper")]IMapper mapper, IRegionManager regionManager, ServiceFactory serviceFactory)
        {
	        Mapper = mapper;
	    ...
	    private void ExecuteSaveCommand()
        {
            ...
            CommandServiceClient.AddOrder(ClientId, orderData);
